...
public class ThirdPartyDrawableFactory extends DrawableFactory {
    ...
    public static final DaggerSingletonObject<ThirdPartyDrawableFactory> INSTANCE =
            new DaggerSingletonObject<>(LauncherAppComponent::getThirdPartyDrawableFactory);

    @Inject
    public ThirdPartyDrawableFactory(@ApplicationContext Context context) {
